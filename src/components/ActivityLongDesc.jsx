...
export const ActivityLongDesc = ({ content }) => {
    ...
    // If content is a string (HTML from Jodit), render it directly
    if (typeof content === 'string') {
        return (
            <section 
                className=" !text-sm mt-2 text-neutral-900 dark:text-neutral-100"
                dangerouslySetInnerHTML={{ __html: content }}
            />
        );
    }

    // If content is already in Strapi blocks format, use BlocksRenderer
    return (
