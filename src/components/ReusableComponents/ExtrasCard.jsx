export const ExtrasCard = ({ data, accent1, accent2 }) => {
    ...
    return (
        <div className='flex items-center justify-center md:mx-24 2xl:mx-80'>
            <div className='py-24 flex flex-col flex-wrap'>
                {data.types.map((type, index) => (
                    <div key={index} className='mb-10 flex flex-col flex-wrap items-center justify-center'>
