            ...
            <section className="md:mx-24 mx-5 space-y-8 mb-20 2xl:mx-80">
                ...
                <div className="flex md:flex-row flex-col gap-5">
                    {DataWhyUs.points.map((el, idx) => (
                        <>
                            <div key={idx} className="md:w-[25%] duration-300 ease-in-out md:hover:w-[50%] p-5 rounded-3xl bg-mainColor dark:bg-baseColor dark:bg-opacity-25 hover:bg-opacity-40 dark:hover:bg-opacity-50 bg-opacity-15">
