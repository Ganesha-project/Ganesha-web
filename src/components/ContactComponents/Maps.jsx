...
export const Maps = () => {
    return (
        <>
           <section className="m-5 lg:m-24 2xl:mx-80 space-y-5">
                    ...
                    <div className="space-y-5">
                        {dataContact.address.map((el, idx) => (
                            <div key={idx} className="self-end duration-300 hover:invert">
                                ...
                                <Link 
                                href="https://maps.app.goo.gl/XYd5ADAXJhwPgAKJ7"
                                 className="w-full lg:w-[40vw] hover:brightness-110 duration-300 ease-in-out flex items-center gap-4 bg-neutral-100 dark:bg-darkColor rounded-b-3xl px-4 py-2 md:p-6"
                                 >
