                    ...
                    <div key={el.type} className="max-w-sm p-6 bg-gradient-to-b from-violet-100 to-violet-200 rounded-[40px] hover:bg-gradient-to-t hover:from-violet-100 hover:to-violet-200 mb-4 md:mb-0">
                        <div href="#" className="max-w-sm">
                            ...
                            <div className="mt-3 flex justify-center">
                                <a
                                    href={el.link}
                                    className="text-white font-extrabold w-full md:w-full bg-gradient-to-br from-violet-600 to-rose-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-rose-300 dark:focus:ring-rose-800 rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">
                                    Konsultasi Sekarang
                                </a>
                            </div>
                            <div className='mt-4'>
