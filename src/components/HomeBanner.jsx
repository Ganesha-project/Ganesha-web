            ...
            <div className="flex flex-col justify-center h-full gap-3">
              <div className="flex flex-col justify-between py-5 gap-5">
                <h1 className="text-4xl font-[500] tracking-[1px] capitalize relative py-5">
                  <span className="text-rose-400">one</span> <br />
                ...
                <div className="relative textsec darl:text-baseColor">
                  <p className="">
                    Temukan solusi lengkap untuk semua kebutuhan bisnis Anda di
                    Ganesha Consulting! Kami memberikan layanan all-in-one untuk
          ...
          <div className="absolute z-10 inset-0 flex flex-col justify-center h-full gap-3">
            <div className="flex flex-col justify-between py-5 gap-5 mx-5">
              <h1 className="text-xl font-[500] tracking-[1px] capitalize relative py-5">
                <span className="text-rose-200">one</span> <br />
              ...
              <div className="space-y-1 mt-10">
                <p className="text-sm text-white">Resmi terdaftar di:</p>
                <div className="flex flex-wrap gap-3 relative">
                  {governLogo.map((el, idx) => (
                    <Image
                      ...
                      width={100}
                      height={100}
                      className="w-[50px] h-[50px] object-cover z-20 drop-shadow-[0px_0px_20px_#ffffff] relative text-black"
                      src={el.logoPath}
                      alt={el.name}
                    />
                  ))}
