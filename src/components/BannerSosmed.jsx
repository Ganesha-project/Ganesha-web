        ...
        <>
            ...
            <div className="px-10 md:px-20 lg:px-36 py-10 md:py-16 lg:py-24">
                <div className="flex flex-col-reverse md:flex-row gap-10 items-center">
                    <Image src={medsosPict} className="dark:invert saturate-150 dark:hue-rotate-180  w-full order-1 md:w-[50%] h-auto md:h-[50vw] lg:h-auto object-cover" alt="medsos image" />
            ...
            <div className="m-10 lg:m-32 md:m-10 flex flex-wrap gap-5 md:gap-7 justify-center">
                <p className="bg-violet-100 p-5 text-gray-900 rounded-[40px] text-3xl lg:text-5xl lg:leading-normal font-bold lg:w-[70vw] text-left capitalize">Apasih Kelebihan Social Media Management Di <span className='bg-violet-800 bg-clip-text text-transparent font-extrabold '>Ganesha Consulting</span>?</p>
