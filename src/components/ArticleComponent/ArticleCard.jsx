                            ...
                            <Link
                                ...
                                <div className="space-y-1 flex md:flex-col flex-row gap-2 w-full h-full">
                                    ...
                                    <div className="space-y-1 md:w-full w-[50%] flex flex-col justify-between h-auto dark:text-white">
                                        <div>
                                            <h1 className="font-bold text-xl text-gray-900 dark:text-gray-100 group-hover:text-mainColor dark:group-hover:text-baseColor duration-150 truncate-last">
                                                {el?.attributes?.Title}
                                            </h1>
                                            <h2 className="truncate dark:text-gray-200 text-gray-700">
