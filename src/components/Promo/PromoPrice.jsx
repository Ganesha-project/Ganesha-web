...
>
  {displayData.map((el, idx) => (
    ...
    >
      {/* === Highlighted Card === */}
      <div
        className={`flex flex-col justify-center gap-3 mt-3 p-4 rounded-2xl text-mainColor dark:text-white bg-neutral-100/90 backdrop-blur-2xl shadow-lg relative overflow-hidden`}
      >
        {/* layer 2 */}
        <img
          src="https://i.pinimg.com/736x/0d/6d/43/0d6d436be6bced302f0248c3c56b891b.jpg"
          alt="bg-highlight light"
          className="absolute inset-0 object-cover w-full h-full dark:hidden"
        />
        <img
        ...
        <div className="relative space-y-3">
          <div className="flex items-center justify-between">
            <div className="rounded-full bg-neutral-100 dark:bg-darkColor dark:text-white w-fit p-2">
              <PiStarFourFill />
            </div>
