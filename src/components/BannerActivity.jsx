                ...
                <div className="w-full bg-darkColor h-[40lvh] relative group">
                    ...
                    <div className="absolute inset-0 w-full h-full">
                        <div className="flex flex-col gap-1 md:gap-3 items-center justify-center h-full px-10">
                            <h1 className="text-2xl pb-1 md:text-4xl font-bold bg-gradient-to-tr from-neutral-800 via-neutral-600 to-sky-800 bg-clip-text text-transparent">
                                Our Activity
                            </h1>
                            <p className="text-sm md:text-base text-center font-medium bg-gradient-to-tr from-neutral-800 via-neutral-600 to-sky-800 bg-clip-text text-transparent">
