  ...
  return (
    <main className="md:px-24 2xl:px-70 px-5 my-24">
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        {/* Left side form */}
        <div className="bg-gray-100 h-full flex flex-col justify-center px-8 rounded-4xl drop-shadow-2xl">
          <h1 className="text-4xl font-bold mb-4">Kritik & Saran</h1>
          ...
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="px-6 py-2 bg-indigo-600 w-full py-5 text-white font-medium rounded-lg hover:bg-indigo-700 transition"
            >
              Kirim Feedback
            </button>
          </form>
        ...
        <div className="relative w-full h-[300px] md:h-[600px] rounded-2xl overflow-hidden">
          ...
          <div className="relative z-10 flex items-end justify-start h-full p-6">
            <div className="relative bg-white/30 backdrop-blur-md border border-white/40 shadow-lg rounded-4xl py-4 px-6">
