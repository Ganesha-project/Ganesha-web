    ...
    return (
        <>
            <div className="z-40 absolute top-1/2 left-1/3 ml-10 transform -translate-x-[65%] -translate-y-1/2" >
                <h1 className="mb-5 text-gray-800 w-[50vw] font-extrabold text-6xl lg:text-9xl">List Paket <span className="bg-[#e58653] bg-clip-text text-transparent rounded-xl" >Menarik</span> Kami!</h1>
