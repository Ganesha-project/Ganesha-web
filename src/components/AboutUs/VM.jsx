        ...
        <>
            <section className="md:m-24 m-5 py-10 md:py-20">
                <div className="flex md:flex-row justify-between flex-col gap-5">
                    <div className="md:border-r-2 md:border-b-0 border-b pb-2 md:pb-0 border-neutral-500  md:pr-5 md:w-[70%]">
                        <h1 className="text-secondaryColor text-3xl md:text-5xl tracking-wider font-bold">
                            Vision
                        </h1>
                        <h1 className="truncate text-3xl md:text-5xl tracking-wider text-neutral-500 dark:text-neutral-300">
                            & Mission
                        </h1>
                    </div>
                    <div className="space-y-5">
                        <div className="md:pl-5 space-y-5">
                            <div className="space-y-2">
                                <h1 className="bg-gradient-to-t from-baseColor text-neutral-900 tracking-wider font-semibold dark:from-secondaryColor to-transparent px-3 py-1 dark:text-white rounded-full w-fit text-sm uppercase">
                                    Vision
                                </h1>
