        ...
        <div id='legal' />
            ...
            <div className="m-10 lg:m-32 flex flex-wrap justify-center gap-7">
                {data.packages.map((el) => (
                    <div key={el.type} className="max-w-sm p-6 bg-gradient-to-b from-orange-100 to-orange-200 rounded-[40px] hover:bg-gradient-to-t hover:from-orange-100 hover:to-orange-200 mb-4 md:mb-0">
                        <div href="#" className="max-w-sm">
                            <div className='flex justify-center'>
                                <h5 className="text-orange-600 mt-2 uppercase text-center text-3xl font-bold tracking-tight">
                                    {el.type}
                                </h5>
                            </div>
                            ...
                            <p className="text-center font-bold text-orange-800 text-3xl">
                                {formatToRupiah(el.price)}
                            </p>
                            <div className="mt-3 flex justify-center">
                                <a 
                                href={el.link}
                                className="text-white font-extrabold w-full md:w-full bg-gradient-to-br from-orange-600 to-yellow-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:focus:ring-yellow-800 rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">
                                    Konsultasi Sekarang
                                </a>
                            </div>
                            <div className='mt-4'>
                                {el.features.map((feature) => (
                                    <div className='flex gap-3 self-start align-middle items-center'>
