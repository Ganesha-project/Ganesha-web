                    ...
                    <div key={el.type} className="max-w-sm p-6 bg-gradient-to-b from-cyan-100 to-cyan-200 rounded-[40px] hover:bg-gradient-to-t hover:from-cyan-100 hover:to-cyan-200 mb-4 md:mb-0">
                        <div href="#" className="max-w-sm">
                            ...
                            <div className="mt-3 flex justify-center">
                                <a 
                                href={el.link}
                                className="text-white font-extrabold w-full md:w-full bg-gradient-to-br from-cyan-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">
                                    Konsultasi Sekarang
                                </a>
                            </div>
                            <div className='mt-4'>
