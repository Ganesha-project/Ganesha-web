                                            ...
                                            {el.items.map((el, idx) => (
                                                <div
                                                    ...
                                                    <div className="absolute bottom-5 left-5 flex flex-col gap-2">
                                                        <h2 className={`bg-gradient-to-tr dark:from-gray-100 from-gray-800 dark:via-gray-200 via-gray-600 to-mainColor dark:to-secondaryColor bg-clip-text text-transparent font-medium text-xl md:text-3xl`}>
                                                        ...
                                                        <a
                                                            href={el.link}
                                                            className={`text-sm bg-[#2e2e2e] dark:bg-gray-200 w-fit px-3 text-center dark:text-gray-800 text-white py-1 rounded-full font-bold ease-in-out duration-300 hover:scale-95`}>
                                                            Konsultasi Sekarang
                                                        </a>
                                                    </div>
                                                </div>
