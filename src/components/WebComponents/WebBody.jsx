...
export const WebBody = () => {
    return (
        <>
            <div className="m-10">
                <div className="w-full min-h-fit p-5 md:p-10 lg:p-32 flex flex-col md:flex-row items-center">
                    <Image
                        width={600}
                        height={50}
                        className="dark:invert saturate-150 dark:hue-rotate-180  self-end object-cover w-full lg:w-fit md:w-[70%] rounded-md"
                        src={webitem}
                        alt="image web"
                    />
                    <div className="bg-sky-100 dark:bg-sky-900 dark:text-white p-5 rounded-[40px] md:ml-10 flex-grow">
