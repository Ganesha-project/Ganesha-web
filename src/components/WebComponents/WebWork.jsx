...
// import { WebWorkSkeleton } from "../Skeleton/WebWorkSkeleton";
...
//       setLoading(true);
//       try {
//         const response = await fetch("https://ganesha-cms.vercel.app/api/projects?serviceId=3&limit=20");
...
//         <div
//           className={
//             "md:mx-24 mx-5 2xl:mx-80 flex md:items-center justify-between md:flex-row flex-col"
//           }
//         >
...
//           {loading ? (
//             <WebWorkSkeleton itemsToShow={itemsToShow} />
//           ) : (
//             <div
