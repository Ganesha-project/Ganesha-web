  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Ganesha Consulting menyediakan solusi all-in-one untuk bisnis Anda, termasuk pendirian PT atau CV, pengembangan website, manajemen media sosial, legalitas usaha, desain grafis, perpajakan, dan perizinan lainnya."
        />
        <meta
          name="keywords"
          content="Ganesha Consulting, pendirian PT, pendirian CV, PT PMA, pajak, konsultan pajak, konsultan bisnis, solusi bisnis, pengembangan website, manajemen media sosial, legalitas usaha, desain grafis, perpajakan, perizinan, konsultasi IT, transformasi digital, pengembangan website, manajemen media sosial, Ganesha Consulting"
        />
        <meta name="author" content="Ganesha Consulting" />
        <meta
          property="og:title"
          content="Ganesha Consulting - Solusi Bisnis All-in-One"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="https://www.ganeshaconsulting.co.id/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FArtboard2.b33b65bb.png&w=96&q=75"
        />
