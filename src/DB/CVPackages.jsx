const defaultSourcePage = "pendirian-cv";
...
const cvKeywords = [
    ...
    "legalitas CV",
    "proses bikin CV",
    "pendaftaran CV online",
    "struktur CV",
    "CV mitra komanditer",
    "CV mitra komplementer",
    "keuntungan bikin CV",
    "berapa lama bikin CV",
    "jasa pendirian CV",
    "CV perorangan",
    "CV untuk UMKM",
    "contoh akta CV"
...
export const CVPackages = CVPackagesRaw.map((pkg) => ({
    ...pkg,
    sourcePage: pkg.sourcePage || defaultSourcePage,
    keywords: pkg.keywords?.length ? pkg.keywords : cvKeywords,
}));