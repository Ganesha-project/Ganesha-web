            ...
            text: (
                <>
                    <p className="text-sm md:!text-lg">
                        ...
                        <br />
                        <span className="font-bold text-2xl md:text-3xl bg-gradient-to-tr dark:from-neutral-100 from-neutral-800 dark:via-neutral-300 via-neutral-600 to-sky-800 dark:to-sky-300 bg-clip-text text-transparent">
